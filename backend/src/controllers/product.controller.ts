...
export const getProducts = async (
  ...
  try {
    ...
    const sortMapping: Record<string, string> = {
      ...
      newest: "createdAt",
      oldest: "createdAt",
      popularity: "viewCount", // Use viewCount as primary popularity metric
      sales: "salesCount",
      views: "viewCount",
      featured: "isFeatured",
      createdAt: "createdAt",
    ...
    // Validate and map sortBy parameter
    const validSortBy = sortMapping[sortBy] || "createdAt";

    // Adjust sort order for specific cases
    ...
    if (sortBy === "price-low") {
      ...
      // For popularity-based sorting, always use DESC (highest first)
      finalSortOrder = "DESC";
    }
    ...
    const { count, rows: products } = await Product.findAndCountAll({
      ...
      order: [[validSortBy, finalSortOrder as string]],
      distinct: true,
    });
...
export const getProductById = async (
  ...
  try {
    ...
    // Format product with proper image URLs
